                  // There is some Unneccessary code
...
// // Mock logo import - replace with actual import
...
//   // Navigation items (without language selectors)
...
//         {/* Blue header section with enhanced gradient */}
//         <div className="px-4 py-3 text-white relative" style={{ background: 'linear-gradient(to right, #003A79, #01478A, #0052A3)' }}>
//           <div className="flex items-center justify-between">
//             {/* Logo and Bank Name */}
//             <div className="flex items-center space-x-4 relative mt-10">
//               {/* Logo positioned to span blue and yellow sections */}
//               <div className="absolute bottom-[-2.5rem] w-16 h-16 lg:w-20 lg:h-20 overflow-hidden z-40">
//                 <span>
//                   <img
//                     src={ndvs_logo}
//                     alt="Bank Logo"
...
//                 </span>
//               </div>
//               {/* Bank Name and Abbreviation, shifted to avoid logo overlap */}
//               <div className="ml-20 lg:ml-24 flex flex-col">
//                 <div className="text-lg font-bold leading-tight text-left">
...
//             {/* Right side items - Language Selector and RBI License */}
...
const Navbar: React.FC = () => {
  ...
  <div className="flex items-center space-x-4 relative mt-10 w-full">
    ...
    <div className="ml-20 lg:ml-24 flex flex-col w-full">
      <div className="text-lg md:text-xl lg:text-2xl font-bold leading-tight text-left w-full max-w-full break-words">
        THE NASIK ROAD DEOLALI VYAPARI SAHAKARI BANK LTD., NASIK ROAD
      </div>
      <div className="text-base md:text-lg lg:text-xl font-semibold leading-tight text-left w-full max-w-full break-words">
        (NDVS Bank)
      </div>
    </div>
  </div>
