...
// // import rupay from '@assets/images/RuPay-Card.webp';
// // import mastercard from '@assets/images/mastercard-image.webp';
...
//                 <div 
//                   key={index} 
//                   className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 p-6 flex flex-col items-center text-center hover:-translate-y-1 h-full w-full "
//                 >
...
const Spotlight = () => {
  ...
  const bankSpotlights = [
    'New branches have opened this year in Vilholi, Sakur Phata, and Saikheda',
    'Received First Prize in the Banco Award 2025',
    'A Well known bank in Nashik District',
    '90% of our branches are in Nashik City',
