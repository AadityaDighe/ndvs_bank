...
// import personalized_qr_code from "@assets/images/personlized_qr_code.png";
...
//             />
//             <h1 className="text-2xl font-bold text-center text-gray-800 px-4" style={{marginTop: "-200px"}}>
//               {selectedService}
//             </h1>
...
//               {/* Description */}
//               <div>
//                 <h2 className="text-xl font-semibold text-gray-700 mb-2">Service Overview</h2>
//                 <p className="text-gray-600 leading-relaxed">{serviceData.description}</p>
//               </div>

//               {/* Features */}
//               <div>
//                 <h2 className="text-xl font-semibold text-gray-700 mb-3">Key Features</h2>
