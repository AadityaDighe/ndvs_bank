...
const DigitalBankingServices = () => {
  ...
  const services = [
    {
      icon: <MdQrCode className="text-2xl" />,
      name: t('personalized_qr_code'),
      link: '/personalized-qr'
    },
    {
    ...
    {
      icon: <MdAtm className="text-2xl" />,
      name: t('atm_services'),
      link: '/atm-services'
    },
    {
      icon: <MdPhoneIphone className="text-2xl" />,
      name: t('mobile_banking'),
      link: '/mobile-banking'
    },
    {
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                {services.map((service, index) => (
                  <NavLink
                    key={index}
                    to={service.link}
                    className="bg-white p-3 sm:p-4 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 flex items-center gap-3 border border-gray-100"
                  >
