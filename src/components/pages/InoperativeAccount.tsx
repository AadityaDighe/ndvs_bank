...
import data from '../../assets/data/Inop_data.json';
    ...
    return (
        <div className="container mx-auto p-4 mt-15">
            ...
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold">Inoperative Accounts</h1>
...
export default InoperativeAccount;