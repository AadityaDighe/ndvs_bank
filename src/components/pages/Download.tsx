...
import atmDisputeForm from '@assets/pdfs/ATM TRANSACTION DISPUTE FORM.pdf';
import atmApplicationForm from '@assets/pdfs/ATM APPPLICATION FORM.pdf';
import atmCardAndPinMailer from '@assets/pdfs/ATM CARD AND PIN MAILER RE-ISSUE FORM.pdf';
import cdmImps from '@assets/pdfs/CDM ,IMPS ,UPI Dispute form.pdf';
...
const pdfs: PDFItem[] = [
  { name: 'ATM TRANSACTION DISPUTE FORM', filename: atmDisputeForm },
  { name: 'ATM APPPLICATION FORM', filename: atmApplicationForm },
  { name: 'ATM CARD AND PIN MAILER RE-ISSUE FORM', filename: atmCardAndPinMailer },
  { name: 'CDM ,IMPS ,UPI Dispute form', filename: cdmImps },
